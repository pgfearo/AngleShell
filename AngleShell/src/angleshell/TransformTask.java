 ...
 * @author Philip
 */
public class TransformTask extends Task<String> {
    ...
    public TransformTask(Map<String, String> parameterMap, XsltTransformer transformer, Processor proc, FXListener listener, String outPath){
